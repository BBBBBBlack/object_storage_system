...
public abstract class Message {
    ...
    static {
        ...
        messageClasses.put(AskResponseMessage, org.example.protocol.Message.AskResponseMessage.class);
        messageClasses.put(WriteRequestMessage, org.example.protocol.Message.WriteRequestMessage.class);
        messageClasses.put(WriteResponseMessage, WriteResponseMessage.class);
        messageClasses.put(CAskRequestMessage, org.example.protocol.Message.CAskRequestMessage.class);
